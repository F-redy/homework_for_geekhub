...
class Statr:
    ...
    def start(self, new_atm: bool) -> None:
        ...
        интерфейс (`UserMenu`). В зависимости от роли пользователя (инкассатор или обычного
    ...
    def create_test_data(self):
        ...
        Строка 119: Для new_atm устанавливаем new_atm=True.
